...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <p>At 24ocean.co, accessible from https://24ocean.co, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                24ocean.co and how we use it.
                ...
                regards to the information that they shared and/or collect in 24ocean.co.</p>\
            ...
            <p>The personal information that you are asked to provide, and the reasons why you are asked to provide it,
                ...
                company name, address, email address, and telephone number.s</p>
            ...
            <p>24ocean.co follows a standard procedure of using
                ...
                a part of hosting services’ analytics. The information collected by log files include internet protocol
                (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit
                ...
                users’ movement on the website,
                and gathering demographic information.</p>

            <h3>COOKIES AND WEB BEACONS</h3>
            <p>Like any other website, 24ocean.co uses ‘cookies’. These cookies are used to store information including
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of 24ocean.co.
                ...
                are used in their respective advertisements and links that appear on 24ocean.co, which are sent directly
                ...
                Note that 24ocean.co has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h3>Third Party Privacy Policy</h3>
            <p>24ocean.co’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>Another part of our priority is adding protection for children while using the internet. We encourage
                ...
                24ocean.co does not knowingly collect any Personal Identifiable Information from children under the age
...
@endsection
@section('script')
    <script src="{{ asset('assets/js/apps.js')}}" async defer></script>
@endsection
