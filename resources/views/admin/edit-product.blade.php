                                    ...
                                    <div class="form-group @error('category') has-danger @enderror">
                                        ...
                                        <select
                                            ...
                                            @foreach($categories as $category)
                                                <option
                                                    value="{{ $category->id }}" {{ old('category', $product->category)==$category->id?'selected':'' }}>{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                        <small class="form-control-feedback"> {{ $message }} </small>
                                    ...
                                    <div class="form-group @error('status') has-danger @enderror">
                                        ...
                                        <select
                                            ...
                                            @foreach($statuses as $status)
                                                <option
                                                    value="{{ $status->id }}" {{ old('category', $product->status)==$status->id?'selected':'' }}>{{ $status->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('status')
                                        <small class="form-control-feedback"> {{ $message }} </small>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group @error('image') has-danger @enderror">
                                        ...
                                        <input type="file" name="image" data-default-file="{{ !empty($product->image)?asset('images/'.$product->image):'' }}"
